...
public class Solution {
	...
	public String numToWords2(int num) {
		...
		//From Here to last else statement
			...
			result = numToWords2(num/1000) + " Thousand " + numToWords2(num % 1000);
		}
		
		else if(num < 1000000000) {
			result = numToWords2(num/1000000) + " Million " + numToWords2(num % 1000000);
		}
		
		else {
			result = numToWords2(num/1000000000) + " Billion " + numToWords2(num % 1000000000);
		}
